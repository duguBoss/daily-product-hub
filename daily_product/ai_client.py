...
请分析以下网页内容，提取最热门的 {NEWS_COUNT} 条【科技数码产品】相关新闻。
...
【时间判断规则 - 重要】
- 【今日新闻】显示为【时间】格式（只有时和分，没有月和日）：
  - 如 "10:32"、"09:15"、"14:20"（24小时制时间）
  - 或 "刚刚"、"5分钟前"、"1小时前"（相对时间）
- 【历史新闻】显示为【日期】格式（包含月和日）：
  - 如 "4月3日"、"4月1日"、"3月28日"
- 优先选择【今日新闻】（带【时间】格式或"刚刚"的）
- 如果今日新闻不足 {NEWS_COUNT} 条，可以补充最近1-2天的重要新闻

【选择标准】
- 选择内容完整、有具体产品名称或型号的新闻
- 优先选择热门品牌（苹果、三星、华为、小米等）的产品新闻

【输出要求】
请严格返回 JSON 数组格式，不要添加任何其他文字说明：
[{{"title": "新闻标题", "url": "链接地址"}}]
