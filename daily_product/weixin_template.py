...
# 图片模板 - URL 格式（添加最大高度限制）
IMAGE_URL_TEMPLATE = """<img src="{image_src}" style="width: 100%; display: block; max-height: 600px; height: auto; border: none; object-fit: cover; object-position: top;" />"""

# 图片模板 - Base64 格式（添加最大高度限制）
IMAGE_BASE64_TEMPLATE = """<img src="data:image/jpeg;base64,{image_data}" style="width: 100%; display: block; max-height: 600px; height: auto; border: none; object-fit: cover; object-position: top;" />"""
